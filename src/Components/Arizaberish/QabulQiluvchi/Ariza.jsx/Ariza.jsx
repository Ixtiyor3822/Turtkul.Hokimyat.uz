...
const Ariza = ({ customer }) => {
    ...
    return (
        <div className="container">
            ...
            <div className="row">
            <div className="col-6">
                <textarea name="text" id="text" cols="120" rows="7" onChange={changehandler} ref={textmuroajat}></textarea>
            </div>
            </div>
            <div className=" arizabutton">
                <button className="btn btn-primary" onClick={chiqar}>Muroajatingizni yuborish</button>
            </div>
